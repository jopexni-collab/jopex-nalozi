...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    // Isplata — novac IZLAZI iz blagajne. Gotovina koju je komercijalista sakupio
    // (otpremnice) ulazi u blagajnu kad je on preda — nema izmisljenih 'pokrica'.
...
router.post('/:id/storniraj', async (req, res) => {
  ...
  try {
    ...
    // STORNO — vraca iznos u blagajnu (obrnut predznak od isplate).
    await pool.query(
